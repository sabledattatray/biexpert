    ...
    <div className="bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0 divide-y md:divide-y-0 md:divide-x divide-border">
            {[
              ...
              >
                <span className={`text-2xl sm:text-3xl font-bold tracking-tighter ${item.color} group-hover:scale-110 transition-transform duration-300 inline-block`}>
                  {item.stat}
                </span>
                ...
                <span className="mt-3 text-[10px] font-bold uppercase tracking-widest text-muted-foreground/50 group-hover:text-blue-400 transition-colors flex items-center gap-1">
        ...
        <div className="border-t border-border bg-background/40">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8">
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-muted-foreground/60 whitespace-nowrap shrink-0">
                Clients include
              </span>
      ...
      <section className="py-24 border-t border-border relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 border border-emerald-500/20 bg-emerald-500/5 text-emerald-400 text-[10px] font-bold uppercase tracking-[0.3em] mb-6">
                Measurable Impact
              </div>
              <h2 className="text-4xl sm:text-[46px] font-bold tracking-tighter text-foreground leading-tight mb-6">
                We Build Dashboards   That <span className="text-emerald-400">Actually Work.</span>
              </h2>
            ...
            <div className="relative aspect-video bg-card border border-border overflow-hidden group">
              ...
              <div className="absolute bottom-6 left-6">
                <p className="text-[10px] font-bold uppercase tracking-widest text-blue-400 mb-1">Featured Solution</p>
                <h3 className="text-xl font-bold text-foreground">MIS Automation Framework</h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 border-t border-border bg-gradient-to-b from-background to-secondary/30">
        <div className="container mx-auto px-6 lg:px-12 text-center max-w-4xl">
          <h2 className="text-3xl sm:text-[46px] font-bold tracking-tighter text-foreground leading-none mb-4">
            Ready to Rule   
