    ...
    <div className="min-h-screen pt-16 pb-20 flex items-center justify-center relative overflow-hidden">
      ...
      >
        <div className="text-center mb-6">
          ...
          <h1 className="text-3xl font-bold tracking-tighter text-foreground uppercase mb-2">Welcome Back</h1>
        ...
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between ml-1">
              ...
              <Link href="#" className="text-[10px] font-bold uppercase tracking-widest text-blue-500 hover:text-blue-400">Forgot?</Link>
            </div>
            <div className="relative">
          ...
          <Button className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white font-bold uppercase tracking-widest text-xs rounded-none border-0 shadow-lg shadow-blue-500/20">
            Sign In <Zap size={14} className="ml-2" />
          </Button>

          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-border"></div></div>
            <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-widest"><span className="bg-card px-4 text-muted-foreground">Or continue with</span></div>
          </div>
        ...
        <div className="mt-8 flex items-center justify-center gap-2 opacity-50">
          ...
          <span className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground">Secure Enterprise Access</span>
        </div>
      </motion.div>
    </div>
  );
