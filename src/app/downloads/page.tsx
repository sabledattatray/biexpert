    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative pt-32 pb-24 overflow-hidden border-b border-border">
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-violet-600/5 blur-[120px] rounded-full animate-pulse" />
        </div>
        ...
        <div className="container mx-auto px-6 lg:px-12 relative text-center">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1 border border-blue-500/20 bg-blue-500/5 text-blue-400 text-[10px] font-black uppercase tracking-[0.3em] mb-8">
              <Download size={12} /> The Data Vault
            </div>
            
            <h1 className="text-5xl sm:text-7xl font-black tracking-tighter leading-[0.85] mb-8 uppercase text-foreground">
              Datasets & <br />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
             ...
             {!session && (
               <form action={async () => { "use server"; await signIn("google", { redirectTo: "/downloads" }); }}>
                 <Button type="submit" className="h-10 px-8 bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-widest text-[10px] rounded-none">
              ...
              <div key={ds.id} className="group relative bg-card border border-border p-8 hover:border-blue-500/50 transition-all duration-500 overflow-hidden">
                {!session && (
                  <div className="absolute inset-0 z-10 bg-background/80 backdrop-blur-[2px] flex items-center justify-center group-hover:bg-background/60 transition-colors">
                    <div className="text-center p-6">
                       ...
                       <p className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">Locked Resource</p>
                    </div>
                  </div>
                )}
                ...
                <div className="relative z-0">
                  <div className="flex items-start justify-between mb-8">
                    ...
                    <span className="px-3 py-1 bg-muted border border-border text-[9px] font-black uppercase tracking-widest text-muted-foreground">
                      {ds.type}
                    </span>
                  </div>

                  <div className="mb-8">
                    <span className="text-[9px] font-black uppercase tracking-widest text-blue-400 mb-2 block">{ds.category}</span>
                    <h3 className="text-2xl font-black uppercase tracking-tighter text-foreground mb-4 group-hover:text-blue-400 transition-colors">
                      {ds.title}
                    </h3>
                  ...
                  <div className="flex items-center justify-between pt-8 border-t border-border">
                    ...
                    {session ? (
                      <a 
                        ...
                        className="h-10 px-6 bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-widest text-[10px] flex items-center justify-center gap-2 transition-colors cursor-pointer"
                      >
                        <Download size={14} /> Download
                      </a>
                    ) : (
                      <div className="h-10 px-6 border border-border text-muted-foreground/30 font-black uppercase tracking-widest text-[10px] flex items-center gap-2 italic">
        ...
        <section className="pb-24">
          <div className="container mx-auto px-6 lg:px-12 text-center">
            <div className="max-w-xl mx-auto p-12 border border-blue-500/20 bg-blue-500/5">
               ...
               <h3 className="text-2xl font-black uppercase tracking-tighter text-foreground mb-4">Enterprise Grade Security</h3>
               <p className="text-sm text-muted-foreground mb-8">
                 We use Google OAuth to verify your identity and protect our proprietary datasets from unauthorized scraping.
               </p>
               <form action={async () => { "use server"; await signIn("google", { redirectTo: "/downloads" }); }}>
                 <Button type="submit" className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-widest text-[10px] rounded-none shadow-xl shadow-blue-600/20">
