          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {pillars.map((p, i) => (
              ...
              >
                ...
                <h2 className="text-3xl font-bold mb-6 uppercase tracking-tighter text-foreground">{p.title}</h2>
      ...
      <section className="py-40 text-center relative">
        <div className="container mx-auto px-6 lg:px-12">
          <h2 className="text-[46px] sm:text-[46px] font-bold tracking-tighter mb-10 leading-none text-foreground">
            READY TO RULE READY TO RULE <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-violet-500 underline underline-offset-[10px] decoration-border">YOUR MARKET?</span>
          </h2>
